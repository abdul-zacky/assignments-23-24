...
public class MainMenu {
    ...
    public static void handleCetakBill(User user) {
        ...
        while (true) {
            ...
            System.out.println("");
            System.out.print(outputBillPesanan(order, user));
            return;
        }
    }
    ...
    public static String getValidRestaurantName() {
        ...
        while (!isRestaurantNameValid) {
            ...
            if (restoList != null) {
                isRestaurantExist = restoList.stream()
    ...
    public static void handleHapusRestoran() {
        ...
        while (!isActionDeleteEnded) {
            ...
            if (!isRestaurantExist) {
                ...
                restoList = new ArrayList<>(restoList.stream()
                        .filter(restaurant -> !restaurant.getNama().toLowerCase().equals(restaurantName.toLowerCase()))
                        .toList());
